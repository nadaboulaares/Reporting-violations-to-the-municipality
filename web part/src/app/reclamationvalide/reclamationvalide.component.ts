...
declare var M: any;
@Component({
  selector: 'app-reclamationvalide',
  templateUrl: './reclamationvalide.component.html',
  styleUrls: ['./reclamationvalide.component.css'],
  providers: [ReclamationService],
})
export class ReclamationvalideComponent implements OnInit {
